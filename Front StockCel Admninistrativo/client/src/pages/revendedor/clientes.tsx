...
import { Plus, Edit, Trash2, Search, Filter, User, Mail, Phone, MapPin, UserPlus } from "lucide-react";
...
export default function RevendedorClientes() {
  ...
  // Filter only active licenses for the dropdown
  const activeLicencias = licencias.filter(l => l.estado === "activa");
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">
                  {clientes.length === 0 ? "No has agregado clientes aún" : "No se encontraron clientes"}
                </p>
                {clientes.length === 0 && (
